  ...
  return (
    ...
    >
      <div
        ...
        className="relative w-full max-w-lg bg-zinc-950 border border-zinc-800 rounded-3xl p-5 sm:p-6 shadow-2xl shadow-black/80 my-8 animate-in fade-in zoom-in-95 duration-200"
